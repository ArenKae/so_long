...
/*   Updated: 2023/09/29 20:27:05 by acosi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	occurs in the main window. Another hook is responsible for the movements of
	patrols.
...
int	main(int ac, char **av)
{
	...
	if (ac == 2)
	{
		...
		mlx_loop_hook(context.game, init_bonus, &context);
